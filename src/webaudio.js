...
WaveSurfer.WebAudio = {
	...
	/**
     * @returns {Float32Array} Array of peaks for both channel.
     */
    getPeaksMainWaveform: function (length) {
        var buffer = this.buffer;
        var sampleSize = buffer.length / length;
        var sampleStep = ~~(sampleSize / 10) || 1;
        var channels = buffer.numberOfChannels;
        var peaks = new Float32Array(channels*length);
